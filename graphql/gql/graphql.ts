...
export type GetNewTokenMutation = { __typename?: 'Mutation', newToken: { __typename?: 'NewTokensResponse', refreshToken: string, user: { __typename?: 'returnUserFields', email: string, id: number, isAdmin: boolean } } };
